...
- [ ] Light and dark themes meet contrast needs; the 42px app icon keeps its X and three concentric circles prominent over a quieter visible grid before and after theme switching; the favicon geometry remains distinct against its Safari-gray fill at tab size; status always includes text or an accessible label.
