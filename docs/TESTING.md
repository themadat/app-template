...
- [ ] The Safari favicon uses a fully opaque `#8E8E93` background with visible neon-blue geometry, two squares, two circles, every other grid line, and no inset outline; manifest, touch icon, install icon, and splash assets resolve.
