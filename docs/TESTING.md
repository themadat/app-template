...
- [ ] The favicon squircle is filled gray in light browser chrome and filled white in dark browser chrome; manifest, touch icon, install icon, and splash assets resolve.
