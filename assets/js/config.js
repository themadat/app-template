    ...
    releases: [
      {
        ...
        features: [],
        improvements: ["Theme-aware PNG fills and currentColor strokes"],
        fixes: [],
        knownIssues: []
      },
      {
      ...
      },
      {
        ...
        title: "Add String Lights",
        summary: "Added the supplied String Lights artwork as a Custom icon.",
        features: ["String Lights in Home & Appliances and Celebrations & Awards"],
        improvements: ["Theme-aware fill for light and dark appearances"],
        fixes: [],
        knownIssues: []
      },
      {
      ...
      },
      {
        version: "0.0.1.81",
        date: "2026-09-15T12:00:00.000Z",
        title: "Search ignores sources",
        summary: "Icon search matches names, aliases, tags, types, and categories without matching source repositories or file paths.",
        features: [],
        improvements: ["Source filtering remains available separately"],
        fixes: ["Source metadata no longer adds unrelated search results"],
        knownIssues: []
      },
      {
        version: "0.0.1.80",
        date: "2026-09-15T12:00:00.000Z",
        title: "Separate search shortcut badges",
        summary: "The slash shortcut badge sits over the search input, beside the Clear button’s C badge.",
        features: [],
        improvements: [],
        fixes: ["Prevent overlapping slash and C shortcut badges"],
        knownIssues: []
      },
      {
        version: "0.0.1.79",
      ...
      },
      {
        version: "0.0.1.75",
        date: "2026-09-14T12:00:00.000Z",
        title: "Top-bar sync and app updates",
        summary: "Cloud Sync and Update now live in the top bar. What’s New dismisses after 20 seconds, with a configurable timer in Settings.",
        features: ["What’s New dismissal setting from 1–300 seconds", "Top-bar Update action with an available-update indicator"],
        improvements: ["Cloud Sync status stays beside the application actions", "Updates save local changes before checking and refreshing"],
        fixes: ["Available updates no longer open a persistent pop-up"],
        knownIssues: []
      },
      {
        version: "0.0.1.74",
